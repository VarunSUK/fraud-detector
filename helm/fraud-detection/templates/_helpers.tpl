...
*/}}
{{- define "fraud-detection.namespace" -}}
...
eks.amazonaws.com/role-arn: {{ .Values.cloud.aws.iam.roleArn }}
{{- else if eq .Values.cloud.provider "gcp" }}
iam.gke.io/gcp-service-account: {{ .Values.cloud.gcp.workloadIdentity.serviceAccount }}
{{- else if eq .Values.cloud.provider "azure" }}
azure.workload.identity/client-id: {{ .Values.cloud.azure.managedIdentity.clientId }}
{{- end }}
{{- end }}
